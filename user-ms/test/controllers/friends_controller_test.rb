...
class FriendsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create friend" do
    assert_difference('Friend.count') do
      post friends_url, params: { friend: { user_id1: @friend.user_id1, user_id2: @friend.user_id2 } }
    end
  ...
  test "should update friend" do
    patch friend_url(@friend), params: { friend: { user_id1: @friend.user_id1, user_id2: @friend.user_id2 } }
